    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          {translateText("The page you're looking for doesn't exist or has been moved.")}
        </p>
        <div className="mt-6">
          <Link
            to="/"
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="text-xl font-semibold tracking-tight text-foreground">
          {translateText("This page didn't load")}
        </h1>
        <p className="mt-2 text-sm text-muted-foreground">
          {translateText(
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "CommonRoute" },
      {
        name: "description",
        content:
          "CommonRoute turns different preferences and practical needs into one realistic group itinerary.",
      },
      ...
      { name: "theme-color", content: "#23415C" },
      { name: "apple-mobile-web-app-title", content: "CommonRoute" },
